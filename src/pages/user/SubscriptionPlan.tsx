        ...
        <div className="space-y-6">
          ...
          >
            ...
            {subscription.isLifetime && (
              <motion.div
                className="mt-4 mb-6 p-5 bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-400 rounded-2xl shadow-md"
                initial={{ scale: 0.95, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                transition={{ duration: 0.3 }}
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-yellow-800 leading-relaxed mb-2">
                      You have unlimited access to all features. This
