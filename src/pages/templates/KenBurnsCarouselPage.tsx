...
const KenBurnsCarouselPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] font-[Inter,-apple-system,BlinkMacSystemFont,sans-serif] overflow-x-hidden pt-[60px]">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-[#fef3c7] via-[#fde68a] to-[#fafbfc] py-16 px-8 pb-24">
        <div className="max-w-[1200px] mx-auto grid grid-cols-2 gap-16 items-center">
          <div>
            <h1 className="text-5xl font-bold text-[#111827] mb-5 leading-[1.2] animate-[fadeInUp_0.8s_ease-out]">Ken Burns Carousel Templates</h1>
          ...
          <div className="relative animate-[fadeInRight_0.8s_ease-out_0.3s_both]">
            <div className="relative">
              <div className="bg-white rounded-2xl overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.15)] animate-[scaleIn_0.8s_ease-out_0.4s_both] transition-all duration-300 hover:-translate-y-[5px] hover:shadow-[0_30px_60px_-12px_rgba(0,0,0,0.2)]">
                <div className="flex items-center justify-center min-h-[300px] bg-gradient-to-br from-[#fefce8] to-[#fef9c3] relative">
                  <div className="absolute inset-5 bg-black/20 rounded-2xl blur-[8px]"></div>
                  <div className="relative w-[500px] h-[260px] bg-white rounded-xl flex items-center justify-center shadow-[0_15px_40px_rgba(0,0,0,0.2)] text-[#6b7280] overflow-hidden">
                    <img src="https://plus.unsplash.com/premium_photo-1666700698946-fbf7baa0134a?q=80&w=736&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Collage item 2" className="w-full h-full object-cover rounded-[5%] animate-[kenburnsZoom_6s_ease-in-out_infinite_alternate]" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-8 bg-[#fafbfc]">
        <div className="max-w-[1200px] mx-auto text-center">
          <h2 className="text-[2rem] font-bold text-[#111827] mb-3 animate-[fadeInUp_0.6s_ease-out]">Carousel Styles</h2>
          <p className="text-[#6b7280] text-base mb-12 animate-[fadeInUp_0.6s_ease-out_0.1s_both]">Choose your animation effect:</p>
      ...
      <section className="py-20 px-8 bg-white">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="w-full rounded-2xl overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.15)] bg-[#f3f4f6] mt-5">
            <img src={KBC} className="w-full h-auto block object-cover" />
          </div>
