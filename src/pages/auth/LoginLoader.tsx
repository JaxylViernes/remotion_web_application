  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen w-full overflow-hidden px-6 text-center bg-white">
      ...
      <div className="relative z-10">
        ...
        {/* Video Play Icon with Spinning Loader */}
        <div className="relative w-32 h-32 mb-12 mx-auto animate-slide-up delay-200">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative">
              ...
              <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full shadow-xl animate-play-pulse flex items-center justify-center">
                {/* Play triangle */}
                <div className="w-0 h-0 border-t-[10px] border-t-transparent border-l-[16px] border-l-white border-b-[10px] border-b-transparent ml-1"></div>
              </div>
              
              {/* Recording indicator dot */}
              <div className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full animate-recording-pulse border-2 border-white"></div>
            </div>
          </div>
        </div>
      ...
      <style>{`
        ...
        .animate-play-pulse { animation: play-pulse 2s ease-in-out infinite; }
