...
export const ProjectsSection: React.FC<SavedTemplatesSectionProps> = ({
  ...
  <div className="flex sm:gap-1 bg-gray-100 p-1 rounded-full w-fit">
          <button
  onClick={() => setActiveTab("renders")}
  className={`flex-1 flex items-center justify-center gap-2 px-5 py-2.5 rounded-full sm:flex-initial font-medium text-sm transition-all ${
    activeTab === "renders"
